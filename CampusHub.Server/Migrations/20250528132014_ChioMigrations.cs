...
{
    /// <inheritdoc />
<<<<<<< HEAD:CampusHub.Server/Migrations/20250520133510_AddAcademicYearSemesterFaculty.cs
<<<<<<<< Updated upstream:CampusHub.Server/Migrations/20250520133510_AddAcademicYearSemesterFaculty.cs
    public partial class AddAcademicYearSemesterFaculty : Migration
========
    public partial class TalosMigrations : Migration
>>>>>>>> Stashed changes:CampusHub.Server/Migrations/20250528214224_TalosMigrations.cs
=======
    public partial class ChioMigrations : Migration
>>>>>>> main:CampusHub.Server/Migrations/20250528132014_ChioMigrations.cs
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TipuriDocumente", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Documente_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Documente_TipuriDocumente_TipDocumentId",
                        column: x => x.TipDocumentId,
                        principalTable: "TipuriDocumente",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Grades_AspNetUsers_UserAccountId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Documente_TipDocumentId",
                table: "Documente",
                column: "TipDocumentId");

            migrationBuilder.CreateIndex(
                name: "IX_Documente_UserId",
                table: "Documente",
                column: "UserId");
